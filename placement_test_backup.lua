...
inventory={}
depth_tracker={}
cursor_position=0 -- Where the inventory cursor is
...
function subtract(initial_value,subtract_value)
  local sum=initial_value[subtract_value] or 0 
  initial_value[subtract_value]=sum-1
end
...
function player_inventory()
		...
		if inventory_mode then
				...
				-- Cursor
				-- TODO: Add visual cursor for inventory
